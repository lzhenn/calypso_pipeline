...
def main_run():
    ...
    #wrfout_d01_2022-03-01_17:00:00
    
    # one by one move, call the swan model per 24 hours
    curr_ts=init_ts
    ...
    while (curr_ts<=init_ts+datetime.timedelta(days=run_days)):
        ...
        if ((file_count>0) and (file_count % round_nfiles==0)):
            ...
            if (file_count/round_nfiles==1):
                swan_cfg['CORE']['init_run']=cfg_hdl['CORE']['init_run']
            else:
